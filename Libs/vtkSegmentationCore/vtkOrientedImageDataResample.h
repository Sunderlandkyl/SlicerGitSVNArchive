...
public:
  ...
  static bool MergeImage(vtkOrientedImageData* inputImage, vtkOrientedImageData* imageToAppend, vtkOrientedImageData* outputImage, int operation,
    const int extent[6] = 0, int maskThreshold = 0, double fillValue = 1, bool *outputModified=NULL, double backgroundValue=0, double minimumValue=0, double maximumValue=1);
