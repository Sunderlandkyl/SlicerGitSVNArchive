  ...
  : vtkBinaryLabelmapToClosedSurfaceConversionRule()
{
  ...
  this->ConversionParameters[this->GetSmoothingFactorParameterName()] = std::make_pair("0.0", "Determines the threshold that the closed surface is created at as a fractional value between 0 and 1.");
}
